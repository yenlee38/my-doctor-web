   ...
   <div className={`container ${inactive ? "inactive" : ""}`}>
    <div className="home">
        <div className="main" id="print">
          ...
          <div className="txt-header-table">Người bệnh: {patient ? patient.fullName : ""}</div>
          <div className="txt-header-table">Số điện thoại: {account ? account.username : ""}</div>
          <div className="list">
            <table>
              <tr className="label">
                <th>STT</th>
          ...
          <div className="page">
                ...
                <div className="paging">
                  ...
                  <div
                    className="paging-icon"
                    onClick={() => setPage(parseInt(messages.length / amount) + 1)}
                  >
